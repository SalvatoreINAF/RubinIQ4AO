...
def compute_atm_dispersion(zenith_angle, filter, pression=800, temperature=15):
    """
    ...
    - pression: Atmospheric pressure in hPa (default: 800 hPa).
    ...
    n_lambda_min = refractive_index_formula(lambda_min * 1e-3, pression, temperature)
    n_lambda_max = refractive_index_formula(lambda_max * 1e-3, pression, temperature)
